...
const installLinks = {
  apk: 'https://github.com/anushka9480-alt/IOT_PROJECT/releases/latest/download/medicine-adherence-assistant.apk',
  preview: 'https://github.com/anushka9480-alt/IOT_PROJECT#run-locally',
};
  ...
  return (
    <div className="site-shell">
      ...
      <main id="home">
        ...
        <section className="install-section page-grid" id="install">
          <Reveal className="section-heading">
            <span className="eyebrow">Install & Preview</span>
            <h2>Download the Android build slot and preview the mobile app on your laptop.</h2>
          </Reveal>

          <Reveal className="install-board" delay={0.1}>
            <div className="install-tile">
              ...
              <p>
                The website now includes the Android package release path so users have a single
                install destination from the product page.
              </p>
              <a className="primary-action" href={installLinks.apk} target="_blank" rel="noreferrer">
                Download APK
              </a>
            </div>
            <div className="install-tile">
              ...
              <h3>Preview on laptop</h3>
              <p>
                Run the Expo mobile app with `npm run web` from the project root to preview mobile
                UI changes directly on your laptop screen.
              </p>
              <a
                className="secondary-action"
                href={installLinks.preview}
                target="_blank"
                rel="noreferrer"
              >
                Open preview guide
